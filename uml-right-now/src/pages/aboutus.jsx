    ...
    return (
        <div className="h-auto ">
            <div className="bg-rowdy-blue text-white">
                <h1 className="text-center lg:text-left m-6">{aboutUsText}</h1>
            </div>
            <div className="flex justify-center bg-rowdy-blue text-white mt-10">
                <h1 className="text-left m-6">Team Members</h1>
            </div>
            <CardForAboutUs name="Sam Claflin" linkedin="https://www.linkedin.com/in/SamClaflin/" email="samclaflin7@gmail.com" url={sam} quote="Computers are useless They can only give you answers." />
            <CardForAboutUs name="John E Youte" linkedin="https://www.linkedin.com/in/john-youte-2162391b8" email="johneyoute@gmail.com" url={john} quote="Computers are useless They can only give you answers." />
            <CardForAboutUs name="Anderson Torres" linkedin="https://www.linkedin.com/in/elnito/" email="ato.orte@gmail.com" url={anderson} quote="Computers are useless They can only give you answers." />
            <CardForAboutUs name="Dante Suarez" linkedin="https://www.linkedin.com/in/dante-suarez/" email="dante_suarez@student.uml.edu" url={logo} quote="Computers are useless They can only give you answers." />
        </div>
    )
}
